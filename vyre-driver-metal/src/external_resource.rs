...
///
/// Every record names a live IOSurface, shared buffer or shared texture. The
/// ceiling covers the per-frame imports an interop workload drives through one
/// device and a wide margin above them.
...
struct ImportedResourceTable {
    records: HashMap<u64, MetalImportedResource>,
...
impl ImportedResourceTable {
    ...
    fn admit(&mut self, resource_id: u64, resource: MetalImportedResource) -> Option<u64> {
