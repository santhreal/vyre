...
pub fn downsample_2x(input: &str, output: &str, width: u32, height: u32) -> Program {
    ...
    vyre_libs_builder::builder::stencil::Grid2DComposer::new(OP_ID, out_w, out_h)
        .with_buffers(vec![
        ...
        .build(|_shape, _idx, py, px| {
            let [p00_idx, p10_idx, p01_idx, p11_idx] =
                vyre_libs_builder::builder::stencil::downsample_2x_source_indices(
                    &Expr::var("oy"),
                    &Expr::var("ox"),
                    width,
                );
            vec![
                ...
                Node::let_bind(
                    "r",
                    vyre_libs_builder::builder::stencil::avg4_channel(
                ...
                Node::let_bind(
                    "packed",
                    vyre_libs_builder::builder::stencil::pack_rgba_named("r", "g", "b", "a"),
                ),
                // Write output.
                Node::let_bind(
                    "oidx",
