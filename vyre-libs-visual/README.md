...
The `product-libraries` owner maintains this `libraries` crate at `vyre-libs-visual`.
Its allowed internal production dependencies are: `vyre-foundation`, `vyre-libs-builder`, `vyre-libs-math`, `vyre-megakernel`, `vyre-primitives`, `vyre-spec`.
