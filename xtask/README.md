...
Commands: `abstraction-gate`, `application-runnable`, `architecture-contract`, `backend-extension`, `backend-matrix`, `bench-baselines`, `bench-coverage`, `bench-crossback`, `bench-release`, `bench-smoke-runtime`, `catalog`, `change-closure`, `check-tier-deps`, `ci-concurrency`, `ci-matrix`, `ci-registry`, `ci-required`, `ci-shell`, `ci-steps`, `cli-docs`, `codeowners`, `compile`, `configuration-model`, `conformance-matrix`, `consumer-compilation`, `contract-in-source`, `crate-ownership`, `crate-pages`, `crate-readmes`, `cross-target`, `cuda-parity`, `dep-drift`, `device-test-compilation`, `device-test-gating`, `dialect-lowering`, `doc-claims`, `docs-check`, `docs-coupling`, `docs-references`, `docs-register`, `domain-vocabulary`, `dup-scan`, `engineering-scorecard`, `error-codes`, `evidence-attribution`, `evidence-paths`, `evidence-provenance`, `example-capability`, `feature-isolation`, `feature-matrix`, `feature-msrv`, `file-size`, `frozen-contracts`, `gate-canon`, `gate-dag`, `gate1`, `gates`, `gpu-loudness`, `heuristic-audit`, `host-oracle-elimination`, `hot-path-blocking-wait`, `hot-path-inventory`, `hot-path-nested-rows`, `hot-path-owned-dispatch`, `hot-path-reserve`, `hot-path-scan`, `hot-path-unbounded-cache`, `hot-path-unbounded-read`, `hygiene-matrix`, `internal-dep-versions`, `invariant-paths`, `launch-state`, `layering`, `lego-composability`, `lego-composition-chains`, `lego-composition-depth`, `lego-cross-dialect`, `lego-duplicate-report`, `lego-exemption-liveness`, `lego-name-stems`, `lego-no-reinvention`, `lego-operand-shapes`, `lego-primitive-coverage`, `lego-quick`, `lego-semantic-organization`, `lego-tier-claims`, `lego-trend`, `lint-denied-override`, `lint-expect-fix`, `lint-liveness-evasion`, `lint-one-policy`, `lint-unsafe-budget`, `lint-unsafe-justification`, `list-ops`, `lock-poison-policy`, `lockfile-clean`, `metadata-matrix`, `metal-parity`, `module-layout`, `neutral-crates`, `op-matrix`, `op-names`, `operation-law-decisions`, `operation-schema`, `optimization-corpus`, `optimization-docs`, `optimization-matrix`, `oracle-independence`, `oracle-sweeps`, `package-readiness`, `parity-testing-isolated`, `path-deps-resolve`, `placement-predicates`, `platform-boundary`, `platform-consumer-docs`, `platform-support-matrix`, `portability-evidence`, `print-composition`, `program-wire-fields`, `proptest-coverage`, `public-api-paths`, `public-api-snapshot`, `readback-ring`, `readme-contract`, `release-benchmarks`, `release-certificate`, `release-conformance`, `release-docs`, `release-evidence`, `release-provenance`, `release-workload-matrix`, `repo-hygiene`, `schedule-ownership`, `schema-authority`, `script-ledger`, `shader-source`, `shrink`, `single-backlog`, `source-include-module`, `source-parses`, `source-reachability`, `spirv-parity`, `supported-api`, `test-harness-isolation`, `test-material-placement`, `test-only-capability`, `test-target-membership`, `testing-guides`, `trace-f32`, `tracked-modules`, `unification`, `variant-list-closure`, `verification-budget`, `verify-rewrite-proofs`, `version-matrix`, `vyre-release-gate`, `whats-similar`, `whole-app-evidence`, `wire-determinism`, `workspace-check`, `workspace-clippy`, `workspace-docs`, `workspace-membership`, `workspace-tests`.
...
This crate is the `tooling` layer's `gate-registry` seam, at `xtask`.
Every production dependency on it crosses The subcommand registry and every gate that judges the tree from source text, manifests, workflows and recorded evidence.
