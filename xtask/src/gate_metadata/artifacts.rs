...
pub const PUBLIC_API_ARTIFACTS: &[&str] = &[
    ...
    "docs/public-api/vyre-libs-analysis.txt",
    "docs/public-api/vyre-libs-bitset.txt",
    "docs/public-api/vyre-libs-builder.txt",
    "docs/public-api/vyre-libs-decode.txt",
    "docs/public-api/vyre-libs-device.txt",
    "docs/public-api/vyre-libs-encoding.txt",
    "docs/public-api/vyre-libs-fixpoint.txt",
    "docs/public-api/vyre-libs-graph.txt",
    "docs/public-api/vyre-libs-hash.txt",
    "docs/public-api/vyre-libs-math.txt",
    "docs/public-api/vyre-libs-nn.txt",
    "docs/public-api/vyre-libs-parsing.txt",
    "docs/public-api/vyre-libs-pattern.txt",
    "docs/public-api/vyre-libs-reasoning.txt",
    "docs/public-api/vyre-libs-reduce.txt",
    "docs/public-api/vyre-libs-rule.txt",
    "docs/public-api/vyre-libs-scheduling.txt",
    "docs/public-api/vyre-libs-security.txt",
    "docs/public-api/vyre-libs-solvers.txt",
    "docs/public-api/vyre-libs-text.txt",
