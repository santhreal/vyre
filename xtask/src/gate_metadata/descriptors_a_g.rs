...
pub const GATES_A_G: [GateDescriptor; 56] = [
    ...
    GateDescriptor {
        ...
        inputs: &[
            ...
            "vyre-foundation/src/dialect/descriptor.rs",
            "vyre-megakernel/src/target_bundle.rs",
        ...
        resource_class: ResourceClass::Process,
        proof: "xtask_registry::gates::application_runnable::tests::every_derived_application_reaches_a_lowered_target_payload",
    },
    GateDescriptor {
        ...
        artifacts: &[],
        prerequisites: &["backend-matrix", "operation-schema", "testing-guides"],
    ...
    GateDescriptor {
        ...
        prerequisites: &["crate-ownership", "testing-guides", "verification-budget"],
        resource_class: ResourceClass::Io,
    ...
    GateDescriptor {
        ...
        artifacts: &[],
        prerequisites: &["crate-ownership", "crate-readmes", "docs-check", "testing-guides", "verification-budget"],
        resource_class: ResourceClass::Cpu,
    ...
    GateDescriptor {
        ...
        // Its subject is the whole evidence directory, so it judges what every
        // writer left there. Running before one of them attributes an artifact
        // that the same sweep is about to replace.
        prerequisites: &[
    ...
    GateDescriptor {
        ...
        prerequisites: &[],
        resource_class: ResourceClass::Io,
        proof: "crate::gates::file_size::tests::every_measured_row_is_the_cap_it_declares",
    },
    GateDescriptor {
