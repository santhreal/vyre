...
use crate::gates::dedup_report::validate_duplicate_family_report_artifact;
...
fn artifact_semantic_blockers(
    ...
    let mut blockers = crate::release::repo_boundary::public_artifact_boundary_blockers(artifact, bytes);
