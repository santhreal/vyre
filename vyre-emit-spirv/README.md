...
```console
CARGO_BUILD_JOBS=1 ./cargo_full run -p vyre-emit-spirv --example vyre_emit_spirv_release_surface
```
...
Use [`docs/testing/vyre-emit-spirv.md`](../docs/testing/vyre-emit-spirv.md) for exact commands, Cargo targets, hardware
