...
use vyre_primitives::wire::decode_u32_le_bytes_all as decode_u32;
...
use vyre_libs_pattern::pattern::classic_ac::try_build_ac_bounded_ranges_suffix3_presence_by_region_program;
...
fn program_presence(literals: &[Vec<u8>], haystack: &[u8], region_starts: &[u32]) -> Vec<u32> {
    let case = PackedCase::new(literals, haystack, region_starts);
