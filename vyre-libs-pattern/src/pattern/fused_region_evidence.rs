...
//! for extraction ([`crate::pattern::regex_anchored_window`]) and admission
//! ([`crate::pattern::regex_region_admission`]); the CPU oracle reuses those so
...
pub fn fused_region_evidence_program(
    ...
    let walk = super::regex_region_admission::AnchoredRegionWalk {
        haystack,
        transitions,
        output_offsets,
        region_starts,
