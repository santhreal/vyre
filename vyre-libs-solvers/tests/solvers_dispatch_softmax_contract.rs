...
//! `vyre_libs_math::math::differentiable::softmax_step`. Nothing named it:
...
use vyre_libs_math::math::differentiable::{softmax_step, OP_ID};
use vyre_libs_solvers::solvers::dataflow_compaction_pipeline::dispatch_softmax;
