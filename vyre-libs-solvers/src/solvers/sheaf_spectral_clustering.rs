...
//!
//! Self-consumer for [`sheaf_laplacian_eigenvalue`](vyre_libs_math::math::sheaf_laplacian_eigenvalue).
//!
...
use vyre_libs_math::math::sheaf_laplacian_eigenvalue::sheaf_laplacian_eigenvalue;
use vyre_megakernel::{
