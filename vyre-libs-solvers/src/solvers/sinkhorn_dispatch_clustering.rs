...
mod tests {
    ...
    fn via_decodes_exact_assignments_into_reused_buffer() {
        ...
        let dispatcher = StaticOutputs::new(
            SINKHORN_CONTRACT,
            vec![
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[0, 0]),
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[0, 0]),
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[0, 1]),
            ],
        )
        .expecting_inputs(&[6]);
    ...
    fn via_rejects_extra_outputs() {
        ...
        let dispatcher = StaticOutputs::new(
            SINKHORN_CONTRACT,
            vec![
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[0]),
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[0]),
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[1]),
                vyre_libs_builder::plumbing::host::dispatch_buffers::u32_slice_to_le_bytes(&[9]),
            ],
        )
        .expecting_inputs(&[6]);
