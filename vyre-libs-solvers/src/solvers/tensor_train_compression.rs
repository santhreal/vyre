...
//!
//! Self-consumer for [`tensor_train_decompose`](vyre_libs_math::math::tensor_train_decompose).
//!
...
use vyre_libs_math::math::tensor_train_decompose::tensor_train_decompose_step;
use vyre_megakernel::{
