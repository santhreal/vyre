...
//! [`analyze`](vyre_frontend_rust::borrowck::analyze) engine.
//!
...
/// exactly what the CPU [`analyze`](vyre_frontend_rust::borrowck::analyze) engine returns for that
...
/// at the default.
const DEFAULT_SHARD_WORDS: usize = 8 * 1024 * 1024;
