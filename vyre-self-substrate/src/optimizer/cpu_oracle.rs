...
fn persistent_bfs_oracle(
    ...
    let nodes = vyre_libs::dispatch_buffers::read_u32s(&inputs[0]);
    let edge_offsets = vyre_libs::dispatch_buffers::read_u32s(&inputs[1]);
    let edge_targets_raw = vyre_libs::dispatch_buffers::read_u32s(&inputs[2]);
    let edge_kind_mask_raw = vyre_libs::dispatch_buffers::read_u32s(&inputs[3]);
    let _node_tags = vyre_libs::dispatch_buffers::read_u32s(&inputs[4]);
    let frontier_in = vyre_libs::dispatch_buffers::read_u32s(&inputs[5]);
...
fn parse_ifds_rule_inputs(
    ...
    let intra_proc = vyre_libs::dispatch_buffers::read_u32s(&inputs[0]);
    let intra_src_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[1]);
    let intra_dst_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[2]);
    let inter_src_proc = vyre_libs::dispatch_buffers::read_u32s(&inputs[3]);
    let inter_src_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[4]);
    let inter_dst_proc = vyre_libs::dispatch_buffers::read_u32s(&inputs[5]);
    let inter_dst_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[6]);
    let gen_proc = vyre_libs::dispatch_buffers::read_u32s(&inputs[7]);
    let gen_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[8]);
    let gen_fact = vyre_libs::dispatch_buffers::read_u32s(&inputs[9]);
    let kill_proc = vyre_libs::dispatch_buffers::read_u32s(&inputs[10]);
    let kill_block = vyre_libs::dispatch_buffers::read_u32s(&inputs[11]);
    let kill_fact = vyre_libs::dispatch_buffers::read_u32s(&inputs[12]);
