...
use super::cpu_statement_expr_with_asm_in_init_classifies::*;
use super::*;
...
#[test]
pub(crate) fn gpu_parity_macro_shaped_declaration_define_per_cpu() {
...
#[test]
pub(crate) fn gpu_parity_macro_shaped_declaration_list_head() {
    let fix = fixture_macro_shaped_declaration_list_head();
...
pub(crate) fn fixture_nested_conditional_preproc() -> Fixture {
    assemble_fixture(&[
        ("#if 1", TOK_PREPROC),
        ("\n", TOK_WHITESPACE),
        ("int", TOK_INT),
