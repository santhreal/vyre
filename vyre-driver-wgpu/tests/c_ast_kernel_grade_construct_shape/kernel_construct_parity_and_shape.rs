...
use super::classify::*;
use crate::c_ast_gpu_parity_support::{assert_full_pipeline_parity, row_indices};
use vyre_libs::parsing::c::parse::vast::{
    C_AST_KIND_ASSIGN_EXPR, C_AST_KIND_ATTRIBUTE_USED, C_AST_KIND_BREAK_STMT, C_AST_KIND_CASE_STMT,
...
fn asm_attribute_interaction_parity_and_shape() {
    ...
    let typed = classify(&fix);
    assert_ne!(typed.len(), 0, "fixture must produce non-empty typed VAST");
