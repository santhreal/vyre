//! Contract tests for C function parameter scope and prototype scope.
//!
//! C11 semantics:
//!   * Each function definition introduces a new block scope for its parameters
//!   * Each function prototype introduces a new function-prototype scope
//!   * Parameters in a prototype are not visible in the function body
//!   * K&R style parameters are ordinary identifiers in the function body scope
//!   * typedef names can be shadowed by parameters and restored after the function
...
use vyre_libs::parsing::c::sema::lookup::{DECL_KIND_FUNCTION, DECL_KIND_NONE, DECL_KIND_VARIABLE};
