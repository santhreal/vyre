...
fn hostile_mixed_flow_full_parity_and_pg_lower() {
    let fix = super::c_ast_linux_corpus_hostile_flow_and_pg_parity_contracts_dense_switch_with_fallthrough_classifies_all_stmt_kinds::fixture_hostile_mixed_flow();
