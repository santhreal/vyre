...
#[test]
pub(crate) fn bitfield_struct_classifies_bit_field_decl_rows() {
...
#[test]
pub(crate) fn bitfield_struct_gpu_pg_lower_matches_cpu() {
    let fix = fixture_bitfield_struct();
    let raw = reference_c11_build_vast_nodes(&fix.tok_types, &fix.tok_starts, &fix.tok_lens);
    let annotated = reference_c11_annotate_typedef_names(&raw, fix.source.as_bytes());
    let typed = reference_c11_classify_vast_node_kinds(&annotated);
...
#[test]
pub(crate) fn bitfield_struct_pg_preserves_bit_field_rows() {
    let fix = fixture_bitfield_struct();
    let raw = reference_c11_build_vast_nodes(&fix.tok_types, &fix.tok_starts, &fix.tok_lens);
    let annotated = reference_c11_annotate_typedef_names(&raw, fix.source.as_bytes());
    let typed = reference_c11_classify_vast_node_kinds(&annotated);
...
#[test]
pub(crate) fn function_pointer_table_classifies_pointer_array_and_function_declarator() {
