...
pub(crate) fn run_gpu_macro_expansion(
    input: &[u32],
...
#[test]
pub(crate) fn macro_expansion_at_stream_start_replaces_first_token() {
...
#[test]
pub(crate) fn macro_expansion_at_stream_end_replaces_last_token() {
    let mut fixture = MacroFixture::empty();
...
#[test]
pub(crate) fn macro_expansion_of_every_token_in_stream() {
    let mut fixture = MacroFixture::empty();
...
#[test]
pub(crate) fn macro_zero_length_replacement_removes_token() {
    let mut fixture = MacroFixture::empty();
...
#[test]
pub(crate) fn macro_expansion_exactly_at_max_out_tokens_boundary() {
    let mut fixture = MacroFixture::empty();
    fixture.insert(TOK_IDENTIFIER, 512, &[TOK_INTEGER, TOK_PLUS, TOK_INTEGER]);
...
#[test]
pub(crate) fn macro_expansion_one_past_max_out_tokens_fails() {
    let mut fixture = MacroFixture::empty();
    fixture.insert(TOK_IDENTIFIER, 512, &[TOK_INTEGER, TOK_PLUS, TOK_INTEGER]);
...
#[test]
pub(crate) fn macro_table_hash_collision_last_insert_wins() {
...
#[test]
pub(crate) fn macro_table_overwrite_same_slot_replaces_mapping() {
    let mut fixture = MacroFixture::empty();
    fixture.insert(TOK_IDENTIFIER, 512, &[TOK_INTEGER]);
...
#[test]
pub(crate) fn conditional_mask_on_empty_stream_fails_validation() {
...
#[test]
pub(crate) fn conditional_mask_on_single_token_emits_one() {
...
#[test]
pub(crate) fn conditional_mask_on_all_preproc_tokens_emits_all_ones() {
...
#[test]
pub(crate) fn conditional_mask_on_mixed_token_types_emits_all_ones() {
    let inputs = vec![
        TOK_IDENTIFIER,
        TOK_INTEGER,
        TOK_HASH,
...
#[test]
pub(crate) fn conditional_mask_output_length_equals_input_length() {
...
#[test]
pub(crate) fn macro_adjacent_to_punctuation_preserves_order() {
    let mut fixture = MacroFixture::empty();
...
#[test]
pub(crate) fn macro_replacement_produces_correct_count_for_mixed_expansion() {
    let mut fixture = MacroFixture::empty();
...
#[test]
pub(crate) fn dynamic_macro_expansion_is_deterministic_across_identical_runs() {
    let mut fixture = MacroFixture::empty();
