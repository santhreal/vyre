...
//! | `vyre-runtime/src/resident_work_queue/planner/mod.rs` | **vyre's megakernel scheduler ILP** is solved by relaxing to a continuous family parameterized by `t ∈ [0, 1]` and following the homotopy path on GPU |
...
inventory::submit! {
    vyre_foundation::operation::OperationRegistration::library_unconstrained(
        ...
        Some(|| {
            vec![vec![
                vyre_primitives::wire::pack_u32_slice(&[5u32 << 16, 7u32 << 16]),
                vyre_primitives::wire::pack_u32_slice(&[2u32 << 16, 3u32 << 16]),
                vyre_primitives::wire::pack_u32_slice(&[1u32 << 16]),
