...
pub fn rgba_to_grayscale(input: &str, output: &str, count: u32) -> Program {
    let body = vec![
        ...
        Node::let_bind("r", crate::builder::stencil::unpack_channel("px", 0)),
        Node::let_bind("g", crate::builder::stencil::unpack_channel("px", 8)),
        Node::let_bind("b", crate::builder::stencil::unpack_channel("px", 16)),
        Node::let_bind("a", crate::builder::stencil::unpack_channel("px", 24)),
        Node::let_bind(
            "luma",
            crate::builder::stencil::clamp_u8(Expr::shr(
                Expr::add(
                    Expr::add(
...
pub fn grayscale_to_rgba(input: &str, output: &str, count: u32) -> Program {
    let body = vec![
        Node::let_bind("px", Expr::load(input, Expr::var("idx"))),
        Node::let_bind("y", crate::builder::stencil::unpack_channel("px", 0)),
        Node::let_bind("a", crate::builder::stencil::unpack_channel("px", 24)),
        Node::let_bind(
            "packed_rgba",
            Expr::bitor(
...
pub fn premultiply_alpha(input: &str, output: &str, count: u32) -> Program {
    let body = vec![
        ...
        Node::let_bind(
            "pr",
            crate::builder::stencil::clamp_u8(Expr::div(
