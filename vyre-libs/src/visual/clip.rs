...
pub fn apply_clip_mask(input: &str, mask: &str, output: &str, count: u32) -> Program {
    let body = vec![
        ...
        Node::let_bind("r", crate::builder::stencil::unpack_channel("in_px", 0)),
        Node::let_bind("g", crate::builder::stencil::unpack_channel("in_px", 8)),
        Node::let_bind("b", crate::builder::stencil::unpack_channel("in_px", 16)),
        Node::let_bind("a", crate::builder::stencil::unpack_channel("in_px", 24)),
        Node::let_bind(
            "mask_a",
            crate::builder::stencil::unpack_channel("mask_px", 24),
        ),
        Node::let_bind(
            "new_a",
