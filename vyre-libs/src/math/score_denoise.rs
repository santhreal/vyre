...
pub fn score_denoise_step(
    ...
    let term_x = crate::math::fixed::fixed_mul_16_16_expr(a, Expr::load(x, t.clone()));
    let term_score = crate::math::fixed::fixed_mul_16_16_expr(b, Expr::load(score, t.clone()));
    let term_noise = crate::math::fixed::fixed_mul_16_16_expr(s, Expr::load(noise, t.clone()));
