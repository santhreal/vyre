...
pub(in crate::scan) const FIRST_GATE_BINDING: u32 = 7;
...
pub(in crate::scan) enum PrefilterWidth {
...
impl PrefilterWidth {
    ...
    pub(in crate::scan) const fn mask_count(self) -> u32 {
        match self {
            Self::Unfiltered => 0,
            Self::EndByte => 1,
            Self::Suffix3 => 3,
...
#[derive(Clone, Copy)]
pub(in crate::scan) struct PrefilterGate<'a> {
...
impl<'a> PrefilterGate<'a> {
    ...
    pub(in crate::scan) const fn unfiltered() -> Self {
        Self {
    ...
    pub(in crate::scan) const fn end_byte(end_mask: &'a str) -> Self {
        Self {
    ...
    /// [`FIRST_GATE_BINDING`].
    pub(in crate::scan) const fn suffix3(
        end_mask: &'a str,
        suffix2_mask: &'a str,
        suffix3_bloom: &'a str,
    ) -> Self {
...
pub(in crate::scan) fn gated_ranges_program(
...
pub(in crate::scan) fn ranges_scan_program(
    gate: PrefilterGate<'_>,
    inputs: AcInputBindings<'_>,
    match_count: &str,
    matches: &str,
...
pub(in crate::scan) fn try_build_ranges_scan(
    width: PrefilterWidth,
    dfa: &CompiledDfa,
    pattern_count: u32,
    max_matches: u32,
...
pub(in crate::scan) fn build_ranges_scan(
    width: PrefilterWidth,
    dfa: &CompiledDfa,
    pattern_count: u32,
    max_matches: u32,
