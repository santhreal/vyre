//! CPU oracle for the per-byte class stream.
//!
//! Gated once at the module declaration in the parent.

use super::{UTF8_ASCII, UTF8_CONT, UTF8_INVALID, UTF8_LEAD_2, UTF8_LEAD_3, UTF8_LEAD_4};

/// Validate and classify each byte the same way the emitted kernel does.
