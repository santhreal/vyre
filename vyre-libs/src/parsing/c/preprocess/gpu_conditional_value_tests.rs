use super::{gpu_if_expression, gpu_if_expression_abi, gpu_ifdef_value};
...
fn gpu_if_expression_abi_is_canonical_and_stable() {
    assert_eq!(
        gpu_if_expression_abi::OP_ID,
        "vyre-libs::parsing::c::preprocess::gpu_if_expression"
    );
    assert_eq!(gpu_if_expression_abi::BINDING_TOK_STARTS, 0);
    assert_eq!(gpu_if_expression_abi::BINDING_TOK_LENS, 1);
    assert_eq!(gpu_if_expression_abi::BINDING_DIRECTIVE_KINDS, 2);
    assert_eq!(gpu_if_expression_abi::BINDING_SOURCE, 3);
    assert_eq!(gpu_if_expression_abi::BINDING_MACRO_NAMES_PACKED, 4);
    assert_eq!(gpu_if_expression_abi::BINDING_MACRO_OFFSETS, 5);
    assert_eq!(gpu_if_expression_abi::BINDING_MACRO_VALUES, 6);
    assert_eq!(gpu_if_expression_abi::BINDING_DIRECTIVE_VALUES, 7);
