...
/// Signature of a phase that reads only the node table.
const NODES_ONLY_SIG: ::vyre_driver::registry::Signature = ::vyre_driver::registry::Signature {
    inputs: &[
        ::vyre_driver::registry::TypedParam {
            name: NODES,
            ty: "buffer<u32>",
        },
        ::vyre_driver::registry::TypedParam {
    ...
    outputs: &[::vyre_driver::registry::TypedParam {
        name: RESULT,
        ty: "u32",
    }],
    attrs: &[],
...
/// Signature of a phase that also reads the source haystack.
const WITH_HAYSTACK_SIG: ::vyre_driver::registry::Signature = ::vyre_driver::registry::Signature {
    inputs: &[
        ::vyre_driver::registry::TypedParam {
            name: NODES,
            ty: "buffer<u32>",
...
macro_rules! register_phase {
    ($id:expr, $sig:expr, $build:path) => {
        ::inventory::submit! {
            ::vyre_driver::registry::dialect::OpDefRegistration::new(|| ::vyre_driver::registry::OpDef {
                id: $id,
                dialect: "vyre-libs.parsing.c",
                category: ::vyre_driver::registry::Category::Composite,
                signature: $sig,
...
register_phase!(
    ...
    WITH_HAYSTACK_SIG,
    c11_typedef_visible_name_for_row
);
register_phase!(
    VISIBLE_NAME_FOR_ROW_PACKED_OP_ID,
    WITH_HAYSTACK_SIG,
    c11_typedef_visible_name_for_row_packed_haystack
);
register_phase!(
    DECL_KIND_FOR_ROW_OP_ID,
    WITH_HAYSTACK_SIG,
    c11_typedef_decl_kind_for_row
);
register_phase!(
    DECL_KIND_FOR_ROW_PACKED_OP_ID,
    WITH_HAYSTACK_SIG,
    c11_typedef_decl_kind_for_row_packed_haystack
);
