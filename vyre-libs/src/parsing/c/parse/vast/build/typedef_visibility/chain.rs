...
pub(super) fn vast_field_from_base(vast_nodes: &str, base_var: &str, field: u32) -> Expr {
    decl_context_row_access::load_vast_node_field(vast_nodes, Expr::var(base_var), field)
}

pub(super) fn vast_kind_from_base(vast_nodes: &str, base_var: &str) -> Expr {
    decl_context_row_access::load_vast_node_kind(vast_nodes, Expr::var(base_var))
}
...
pub(super) fn decl_context_base_for_index(idx: Expr) -> Expr {
    decl_context_row_access::decl_context_base(idx)
}
