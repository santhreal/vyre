...
pub fn adaptive_traverse_step(
    ...
    super::frontier_plan::validate_adaptive_frontier(node_count, frontier_in)?;
    let frontier_popcount = super::frontier_plan::adaptive_frontier_popcount_in_domain(
        node_count,
        frontier_in,
        "adaptive_traverse_step",
    )?;
