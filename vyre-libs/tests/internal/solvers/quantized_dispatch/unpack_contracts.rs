...
fn unpack_i4x8_via_dispatches_signed_boundaries() {
    ...
    let out = unpack_i4x8_via(&QuantizedDispatcher, &vyre_test_support::test_parity_oracles::policy(), &packed, values.len() as u32)
...
fn unpack_i4x8_via_reuses_scratch_and_output() {
    ...
    unpack_i4x8_via_with_scratch_into(
        &QuantizedDispatcher, &vyre_test_support::test_parity_oracles::policy(),
        &packed,
        values.len() as u32,
        &mut scratch,
        &mut out,
