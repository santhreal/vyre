...
fn conv_family_fingerprints() -> Vec<(String, String)> {
    ...
    for &(h, w) in CONV_SHAPES {
        ...
        rows.push((format!("conv2d_3x3_direct:{h}x{w}"), fingerprint_hex(&direct)));
        ...
        rows.push((format!("conv2d_3x3_decision:{h}x{w}"), fingerprint_hex(&decision)));
    }
    rows
}
...
fn walk_family_fingerprints() -> Vec<(String, String)> {
    ...
    for &(node_count, out_cap) in WALK_SHAPES {
        ...
        rows.push((
            ...
            fingerprint_hex(&ast_walk_postorder_nodes("nodes", "out", node_count, out_cap)),
        ));
    }
...
const CONV_PINS: &[(&str, &str)] = &[
    ("conv2d_3x3_direct:1x1", "57ad59fc51c5fdf9231281415f254b85266422d52117d5b4f9edf74d473817c1"),
    ("im2col_3x3:1x1", "3bb89380f338405ab83cdaf9773d469758087309d1c022a25234217bdc19d359"),
    ("conv2d_3x3_decision:1x1", "57ad59fc51c5fdf9231281415f254b85266422d52117d5b4f9edf74d473817c1"),
    ("conv2d_3x3_direct:1x5", "56814bc08017d0a879faf770206b272c3c83e05c828029585d3323cfae823104"),
    ("im2col_3x3:1x5", "5cf8daef58d7ec019a9624aba1ae8b7574e60045d6c1a6e2f1ac496c97aa47d8"),
    ("conv2d_3x3_decision:1x5", "56814bc08017d0a879faf770206b272c3c83e05c828029585d3323cfae823104"),
    ("conv2d_3x3_direct:5x1", "613ce86590b5d7835bba2192bcca2b251f4e7468fee611db9ba06b51fa7ec196"),
    ("im2col_3x3:5x1", "ad86f2a385a38c90033114c2bb6f19020e9378f8902775c370a62b1ae08de437"),
    ("conv2d_3x3_decision:5x1", "613ce86590b5d7835bba2192bcca2b251f4e7468fee611db9ba06b51fa7ec196"),
    ("conv2d_3x3_direct:2x3", "620957948987f1f1884b05819cc567df0a3a2b796d61461eca9513f1ebca1302"),
    ("im2col_3x3:2x3", "923cb887e843796c73f4cceb13f91db1104c8b1606bfbbddecc3959fa105c0a3"),
    ("conv2d_3x3_decision:2x3", "620957948987f1f1884b05819cc567df0a3a2b796d61461eca9513f1ebca1302"),
    ("conv2d_3x3_direct:3x3", "dff1981905bc92ae158ff30d6d40429e047af8b3247d8afc5f04481b03f9662a"),
    ("im2col_3x3:3x3", "b2463482d90d0cc0a44f8f49c8a85e38f08d3796be16a15c0c4e1d5ae849a5a3"),
    ("conv2d_3x3_decision:3x3", "dff1981905bc92ae158ff30d6d40429e047af8b3247d8afc5f04481b03f9662a"),
    ("conv2d_3x3_direct:4x4", "1eb1c3b9be19790eeff8c95437daddddf30dee7c639c6e7bf4b4e88f9815f0e5"),
    ("im2col_3x3:4x4", "e11d70f66984287c73a68a77fed3d95737f0828ac887c6509024f0879ac46940"),
    ("conv2d_3x3_decision:4x4", "1eb1c3b9be19790eeff8c95437daddddf30dee7c639c6e7bf4b4e88f9815f0e5"),
    ("conv2d_3x3_direct:8x8", "9376b07e65bd33f647230c2a14c790d09a95abb4f5b62997fa52c1ac992c5de6"),
    ("im2col_3x3:8x8", "6523b1251278b5eb733dc54b32bfd68e0e839a233e4bfec8d3fcb5ba8faa4e3b"),
    ("conv2d_3x3_decision:8x8", "9376b07e65bd33f647230c2a14c790d09a95abb4f5b62997fa52c1ac992c5de6"),
    ("conv2d_3x3_direct:64x63", "80a0e394c01b7f3855c1602a99e24ed548942488547e9368a06dab72d8979bbc"),
    ("im2col_3x3:64x63", "7016be2fde917821feddb1139ace0b5189e0f548ec4746d66cf11a634400ff79"),
    ("conv2d_3x3_decision:64x63", "80a0e394c01b7f3855c1602a99e24ed548942488547e9368a06dab72d8979bbc"),
    ("conv2d_3x3_direct:64x64", "94ab044b3bc64fe726b07cdb97dd1a0aafe7224f9bd08c6ebe6e65e709604a9b"),
    ("im2col_3x3:64x64", "22d35dde4f60e18f010117f1765e845d9397b2fd99e762fd53409446f64f335c"),
    ("conv2d_3x3_decision:64x64", "ad1d28b769e4f14abc2c57b5e069205b3bb04da92505dd1c1115ad0d2758644a"),
    ("conv2d_3x3_direct:65x65", "1df3ff08be5673910cc8c582960c24872c20bb499f7379708f7cefc4309b32e6"),
    ("im2col_3x3:65x65", "b79b16cf7c386d7d95ba1caffcbe28c0462039ad9fe14d5aa140882d19d4a712"),
    ("conv2d_3x3_decision:65x65", "5c31159747fd2b391426d8a65a4cc1db563f8b32b29c65b76a2bb566d056c690"),
];

/// Pinned on the same pre-merge tree.
const WALK_PINS: &[(&str, &str)] = &[
    ("ast_walk_preorder:0/8", "11295d9687e535d7698850881d76428fa6c3be1a7439d773503ea08cdfa62f88"),
    ("ast_walk_postorder_nodes:0/8", "2f8604e9b72ae78bb75d3ff13e05e06a5ba81d70f3efb87801abff9e701902e2"),
    ("ast_walk_preorder:1/8", "e96b7368e16c43972a8e8fb11a28976bc0dcb095c7286ebee3f8ec71c974ffa7"),
    ("ast_walk_postorder_nodes:1/8", "e4295589e720717345f9c752a29d37a2d228304128dfa04b7041fc0327adbd96"),
    ("ast_walk_preorder:1/1", "0ff959771f9edeb9bca907d0ffaac7ff3d6872e5e96c03886f0c74dc97ae1ee0"),
    ("ast_walk_postorder_nodes:1/1", "5fbdd20cdebf42d3c2497a8457415ee43387f83b8450a2f712d4666464587c1c"),
    ("ast_walk_preorder:4/8", "286e652deaaf4cc0e4bb4cecde6e1a0296f81fb0e0c5a6d1ea5b7677263a465d"),
    ("ast_walk_postorder_nodes:4/8", "77316f9e432d027843fc1c928b192bd4d15be064a4998242b492523fb4115e36"),
    ("ast_walk_preorder:6/8", "e338c33a2088656013f475f4b4ce6536936d8683035b30244682106f5f5ef142"),
    ("ast_walk_postorder_nodes:6/8", "78d8677f9876a05706f2a2d89217e26c87c7e021dc6a6b1367fd84a4a4c04a68"),
    ("ast_walk_preorder:8/4", "59d319c45744defef232636d975cfe4a9a818e9b4e766163f39eb35d19e5af01"),
    ("ast_walk_postorder_nodes:8/4", "399d5c021ae004525e4b6468e8b62f09ae451b7d275842309ee01bf655cc177a"),
    ("ast_walk_preorder:8/16", "b603238a54bc2ad580d757b36497a37ef6a39e6763668055ce43d65fa6c9c108"),
    ("ast_walk_postorder_nodes:8/16", "a17f38b0a7a164a7558b4ba5d3f70d25762c8f67ce810dced069cc5f5911e12e"),
    ("ast_walk_preorder:8/1", "f8ddd3966f6b95d1f1bb5ebb7e8e569634f569b6df85b98774232c8f103be471"),
    ("ast_walk_postorder_nodes:8/1", "5746bc5d86291d0e9189d1ef3def7f125bb89d674fda3799ad0cf904ad3bb966"),
    ("ast_walk_postorder:0", "87a0886d2539e3ef5a5f41c38cbcec6427af8fdf787388815c38d7b796eab27b"),
    ("ast_walk_postorder:1", "73ad74681617284bafcebb5314e1734bedc0302fe61b6d324fc015ced7344cb3"),
    ("ast_walk_postorder:4", "88a0bfd385f1dd59e2badfaaf0b8a51b50b087c7b3d77a4d8966f97afd01163f"),
    ("ast_walk_postorder:8", "50bd9700487098de330f4796cf14e12ef3a840b76ff229fd3aef4904705ef1d5"),
];
...
fn run_im2col(h: u32, w: u32, input: &[f32]) -> Vec<f32> {
    ...
    let outputs =
        vyre_reference::reference_eval(&program, &[Value::from(pack_f32_slice(input))])
