...
use vyre_libs::pattern::{build_regex_dfa_pipeline, AnchoredWindowValidator};

/// Build the anchored DFA for one pattern and return its validator-ready DFA.
fn dfa_for(pattern: &str) -> vyre_libs::pattern::RegexDfaPipeline {
...
fn open_ended_repeat_window_uses_the_bounded_replay_policy() {
    ...
    assert_eq!(
        ...
        vyre_libs::pattern::DEFAULT_OPEN_ENDED_REPLAY_LIMIT_BYTES,
