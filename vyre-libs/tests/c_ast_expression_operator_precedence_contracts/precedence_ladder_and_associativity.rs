...
fn shift_operators_precedence_between_additive_and_relational() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_BINARY, TOK_LSHIFT, 11, C_EXPR_ASSOC_LEFT, 0, 3, SENTINEL),
            (3, C_EXPR_SHAPE_BINARY, TOK_PLUS, 12, C_EXPR_ASSOC_LEFT, 2, 4, SENTINEL),
        ],
    );
...
fn relational_operators_precedence_between_shift_and_equality() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_BINARY, TOK_LT, 10, C_EXPR_ASSOC_LEFT, 0, 3, SENTINEL),
            (3, C_EXPR_SHAPE_BINARY, TOK_LSHIFT, 11, C_EXPR_ASSOC_LEFT, 2, 4, SENTINEL),
        ],
    );
    assert_pg_preserves_row(&rows, 1, node_kind::BINARY);
    assert_pg_preserves_row(&rows, 3, node_kind::BINARY);
...
fn equality_operators_precedence_between_relational_and_bitwise_and() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_BINARY, TOK_EQ, 9, C_EXPR_ASSOC_LEFT, 0, 3, SENTINEL),
            (3, C_EXPR_SHAPE_BINARY, TOK_LT, 10, C_EXPR_ASSOC_LEFT, 2, 4, SENTINEL),
        ],
    );
    assert_pg_preserves_row(&rows, 1, node_kind::BINARY);
    assert_pg_preserves_row(&rows, 3, node_kind::BINARY);
...
fn equality_operators_are_left_associative() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_BINARY, TOK_EQ, 9, C_EXPR_ASSOC_LEFT, 0, 2, SENTINEL),
            (3, C_EXPR_SHAPE_BINARY, TOK_NE, 9, C_EXPR_ASSOC_LEFT, 1, 4, SENTINEL),
        ],
    );
    assert_pg_preserves_row(&rows, 1, node_kind::BINARY);
    assert_pg_preserves_row(&rows, 3, node_kind::BINARY);
...
fn compound_assignment_operators_are_right_associative() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_BINARY, TOK_PLUS_EQ, 2, C_EXPR_ASSOC_RIGHT, 0, 3, SENTINEL),
            (3, C_EXPR_SHAPE_BINARY, TOK_MINUS_EQ, 2, C_EXPR_ASSOC_RIGHT, 2, 4, SENTINEL),
        ],
    );
    assert_eq!(
...
fn ternary_right_associativity_chains_correctly() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (1, C_EXPR_SHAPE_CONDITIONAL, TOK_QUESTION, 3, C_EXPR_ASSOC_RIGHT, 0, 2, 5),
            (5, C_EXPR_SHAPE_CONDITIONAL, TOK_QUESTION, 3, C_EXPR_ASSOC_RIGHT, 4, 6, 8),
        ],
    );
...
fn full_precedence_ladder_from_star_to_or() {
    ...
    assert_shape_rows(
        &rows.expr_shape,
        &[
            (19, C_EXPR_SHAPE_BINARY, TOK_STAR, 13, C_EXPR_ASSOC_LEFT, 18, 20, SENTINEL),
            (17, C_EXPR_SHAPE_BINARY, TOK_LSHIFT, 11, C_EXPR_ASSOC_LEFT, 15, 19, SENTINEL),
            (15, C_EXPR_SHAPE_BINARY, TOK_PLUS, 12, C_EXPR_ASSOC_LEFT, 14, 16, SENTINEL),
            (13, C_EXPR_SHAPE_BINARY, TOK_LT, 10, C_EXPR_ASSOC_LEFT, 12, 17, SENTINEL),
