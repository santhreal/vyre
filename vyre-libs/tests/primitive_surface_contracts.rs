...
//! that removes `Node::Barrier { ordering: vyre_foundation::ir::MemoryOrdering::SeqCst }`, `DataType::Shared`, `BufferAccess::Workgroup`,
//! or `BinOp::WaveReduce` fails CI.

use vyre::ir::Node;

/// Node::Barrier { ordering: vyre_foundation::ir::MemoryOrdering::SeqCst }
