...
///
/// Gated with the CPU reference helpers because a consumer crate's tests reach
/// them the same way they reach `cpu_ref`.
...
pub mod graphs {
    ...
    pub const CHAIN_4: CsrGraphView<'static> = CsrGraphView {
        node_count: 4,
    ...
    pub const DIAMOND_4: CsrGraphView<'static> = CsrGraphView {
        node_count: 4,
