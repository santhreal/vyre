...
The `product-libraries` owner maintains this `libraries` crate at `vyre-libs-scheduling`.
Its allowed internal production dependencies are: `vyre-foundation`, `vyre-libs-builder`, `vyre-libs-device`, `vyre-libs-graph`, `vyre-libs-math`, `vyre-libs-parsing`, `vyre-megakernel`, `vyre-primitives`, `vyre-spec`.
