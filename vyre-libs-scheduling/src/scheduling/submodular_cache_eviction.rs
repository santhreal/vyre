...
/// `vyre_libs_math::math::submodular_greedy::argmax_of_marginals` once per retained item.
///
/// # Errors
///
...
mod tests {
    ...
    use vyre_libs_builder::test_parity_oracles::{canonical_inputs, policy, semantic_output, StaticOutputs};
