...
//!
//! Provides source-derived host OS, architecture, endianness, pointer-width, and driver
//! capability matrices; checked numeric conversions; and small typed platform adapters.
...
pub use matrix::{
    DeviceCapabilityProfile, DriverApiFamily, Endianness, HostArch, HostCell, HostOs,
    PlatformSupportMatrix, PointerWidth, UnsupportedPlatformError,
