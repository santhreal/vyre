...
impl ValidationCode {
    ...
    pub fn phase(&self) -> Option<ValidationPhase> {
        match self.as_str() {
            "V056" => Some(ValidationPhase::Capability),
            "V115" | "V116" => Some(ValidationPhase::Composition),
            "V012" | "V016" | "V020" | "V021" | "V022" | "V023" | "V029" | "V030" | "V034"
            | "V041" | "V047" | "V051" | "V052" | "V053" | "V054" | "V066" | "V067" | "V068" => {
                Some(ValidationPhase::Expression)
            }
            "V018" | "V019" | "V033" => Some(ValidationPhase::Limits),
            "V009" | "V010" | "V013" | "V014" | "V025" | "V027" | "V042" | "V043" | "V055"
            | "V057" | "V058" | "V059" | "V060" | "V061" | "V063" | "V064" | "V065" | "V129" => {
                Some(ValidationPhase::Memory)
            }
            "V008" | "V011" | "V031" | "V032" | "V036" | "V045" | "V046" | "V111" | "V112"
            | "V113" | "V114" | "V117" | "V118" | "V119" | "V120" | "V121" | "V122" | "V123"
            | "V124" | "V125" | "V126" | "V127" | "V128" => Some(ValidationPhase::Node),
            "V070" | "V083" | "V105" | "V106" | "V107" | "V108" | "V109" | "V110" | "V130" => {
                Some(ValidationPhase::Program)
            }
            "V028" | "V035" | "V044" | "V084" | "V085" | "V086" | "V087" | "V088" | "V089"
            | "V090" | "V091" | "V092" | "V093" | "V094" | "V095" | "V096" | "V097" | "V098"
            | "V099" | "V100" | "V101" | "V102" | "V103" | "V104" => Some(ValidationPhase::Type),
            _ => None,
        }
    }
}
