...
const SUPPLEMENTAL_OPTIMIZATION_RULES: &[OptimizationCatalogEntry] = &[
    ...
    scalar_rule!("strength_reduce.shift_negation"),
    scalar_rule!("strength_reduce.complement_bounds"),
    scalar_rule!("strength_reduce.div_constant_multiply_shift"),
    scalar_rule!("strength_reduce.mod_power_of_two_mask"),
    scalar_rule!("strength_reduce.mod_constant_subtract_quotient"),
