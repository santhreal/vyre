...
fn expr_sort_key(expr: &Expr) -> u64 {
    match expr {
        ...
        Expr::LogicalIndex { axis } => 0x21_0000_0000 | u64::from(*axis),
        Expr::LogicalTileId { axis } => 0x22_0000_0000 | u64::from(*axis),
        Expr::LogicalWithinTileId { axis } => 0x23_0000_0000 | u64::from(*axis),
