...
fn put_bytes(bytes: &mut Vec<u8>, data: &[u8]) -> Result<(), GraphDeltaError> {
...
fn read_u32(bytes: &[u8], cursor: &mut usize) -> Result<u32, GraphDeltaError> {
...
fn read_u64(bytes: &[u8], cursor: &mut usize) -> Result<u64, GraphDeltaError> {
...
fn read_contract(bytes: &[u8], cursor: &mut usize) -> Result<ValueContract, GraphDeltaError> {
