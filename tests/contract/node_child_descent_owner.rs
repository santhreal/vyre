...
const WAIVERS: &[Waiver] = &[
    ...
    Waiver {
        path: "vyre-driver/src/backend/validation.rs",
        owner: "Backends",
        reason: "driver-side program walk; item-driver-walker routes it through the foundation owner",
    },
    Waiver {
        path: "vyre-driver/src/program_walks/launch_geometry.rs",
        owner: "Backends",
        reason: "driver-side program walk; item-driver-walker routes it through the foundation owner",
    },
    Waiver {
        path: "vyre-driver/tests/grid_sync_nested_fence_survives_split.rs",
        owner: "Backends",
        reason: "grid-sync nesting test; a missed nested fence here is a race, highest-priority conversion",
    },
    Waiver {
