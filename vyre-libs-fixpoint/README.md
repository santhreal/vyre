...
This crate is the `libraries` layer's `libs-fixpoint` seam, at `vyre-libs-fixpoint`.
Every production dependency on it crosses Deterministic fixpoint iteration and grid synchronization compositions.
