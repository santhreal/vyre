...
300. Execute the public launch: `cargo_full publish` for approved crates, verify `santhreal/vyre` is public without changing `Santh`, then `git push` the release branch and tags.
