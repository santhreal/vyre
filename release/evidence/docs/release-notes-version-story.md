...
- Vyre release: `0.6.5`
- Weir release: `0.1.0`
- Required version-matrix packages: `vyre@0.6.5`, `vyre-driver-cuda@0.6.5`, `vyre-driver-wgpu@0.6.5`, `vyrec@0.1.0`, `vyre-frontend-c@0.6.5`, and `weir@0.1.0`; `missing_required_release_packages` must be empty.
...
- Vyre RC tag: `vyre-v0.6.5-rc.1`
- Weir RC tag: `weir-v0.1.0-rc.1`
- Combined release-train RC tag: `vyre-0.6.5-weir-0.1.0-rc.1`
- Vyre tag: `vyre-v0.6.5`
- Weir tag: `weir-v0.1.0`
- Combined release-train tag: `vyre-0.6.5-weir-0.1.0`
...
- Release notes must name `vyre 0.6.5`.
- Release notes must name `weir 0.1.0`.
- Release notes must preserve the required package story: `vyre`, `vyrec`, and `vyre-frontend-c` ship on the `0.6.5` Vyre train, while `weir` ships as `0.1.0`.
- Release notes must name `vyre-v0.6.5-rc.1`.
- Release notes must name `weir-v0.1.0-rc.1`.
- Release notes must name `vyre-0.6.5-weir-0.1.0-rc.1`.
- Release notes must name `vyre-v0.6.5`.
- Release notes must name `weir-v0.1.0`.
- Release notes must name `vyre-0.6.5-weir-0.1.0`.
- Release notes must not instruct maintainers to create or push a bare `v0.6.5` tag for this release train.
