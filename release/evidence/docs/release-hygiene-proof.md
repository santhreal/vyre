...
- `hygiene-matrix.json` must include `release_surface_coverage`, and every required flag must be true for the Vyre workspace, `vyre-driver-cuda`, `vyre-driver-wgpu`, release scripts, GitHub workflows, and branch-protection controls.
