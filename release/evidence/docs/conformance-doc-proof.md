...
- Required fan-in contexts must fail closed on dependency failures; `crate-checks`, `Conform release gate`, and `GPU release gate` cannot rely on skipped dependency semantics.
