//! Round-trip contract of issue, verify and the drift each verifier catches.
...
use super::issue::issue_bundle_cert;
use super::verify::verify_bundle_against_reference;
