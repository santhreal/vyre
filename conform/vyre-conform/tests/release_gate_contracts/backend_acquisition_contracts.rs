...
fn dispatch_conformance_isolates_backend_instance_per_pair() {
    let source = repo_file("conform/vyre-conform/src/main.rs");
...
fn release_conformance_static_sizing_uses_packed_buffer_lengths() {
    for path in [
        "conform/vyre-conform/src/witness_plan.rs",
        "conform/vyre-conform/tests/__split/parity_matrix_chunk1.rs",
    ] {
