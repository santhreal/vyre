...
//! `raw_ir_in_libs__write_lib_file.rs` and its child
//! `raw_ir_in_libs__adversarial_module_named_tests_inside_a_real_module.rs`.

#[path = "contract_cases/raw_ir_in_libs__write_lib_file.rs"]
mod raw_ir_in_libs_write_lib_file;
