...
//! primitive `dense_matvec_*` family owned by `vyre_libs_bitset::bitset::four_russians`
//! and the substrate transform family in `vyre_libs_encoding::encoding::bitset_transform_pipeline`.
...
pub enum FrontierShape {
    ...
    SingleTile {
        /// Index of the one active tile.
        tile: u32,
        /// Source bits set in that tile.
        active_byte: u32,
    },
...
pub fn declared_groups() -> Vec<CaseGroup> {
...
pub type LutBuilder = fn(&[u32], u32, u32) -> Vec<u32>;
...
pub type MatvecProgramBuilder = fn(&str, &str, &str, u32, u32) -> vyre_foundation::ir::Program;
...
pub fn arm_coverage() -> ArmCoverage {
    ArmCoverage::new(
        "dense-matvec",
        "vyre-test-support/src/dense_matvec_cases.rs",
