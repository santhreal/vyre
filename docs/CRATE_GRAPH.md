...
| `vyre-test-support` | `vyre-spec` | declared operation signatures behind the ir-fixtures feature, so a fixture names the same operation the registry does | None | `always` | `normal` | `true` | `true` | `private` | `specification` |
