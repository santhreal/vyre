...
| `test` | `c11_token_table_parity` | `vyre-libs/tests/c11_token_table_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c11_token_table_parity` |
| `test` | `c11_token_table_parity` | `vyre-libs/tests/c11_token_table_parity.rs` | `c-parser` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c11_token_table_parity` |
