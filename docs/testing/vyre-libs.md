...
| `test` | `c_ast_vast_builder_performance_contracts` | `vyre-libs/tests/c_ast_vast_builder_performance_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_ast_vast_builder_performance_contracts` |
...
| `test` | `c_frontend_cpu_oracle_boundary` | `vyre-libs/tests/c_frontend_cpu_oracle_boundary.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_frontend_cpu_oracle_boundary` |
...
| `test` | `c_preprocess_cache_encode_allocation_contract` | `vyre-libs/tests/c_preprocess_cache_encode_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_cache_encode_allocation_contract` |
...
| `test` | `c_preprocess_gpu_allocation_reserve_contract` | `vyre-libs/tests/c_preprocess_gpu_allocation_reserve_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_gpu_allocation_reserve_contract` |
...
| `test` | `c_preprocess_header_reuse_budget_contract` | `vyre-libs/tests/c_preprocess_header_reuse_budget_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_header_reuse_budget_contract` |
| `test` | `c_preprocess_live_conditional_cache_contract` | `vyre-libs/tests/c_preprocess_live_conditional_cache_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_live_conditional_cache_contract` |
| `test` | `c_preprocess_live_state_allocation_contract` | `vyre-libs/tests/c_preprocess_live_state_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_live_state_allocation_contract` |
| `test` | `c_preprocess_lru_index_allocation_contract` | `vyre-libs/tests/c_preprocess_lru_index_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_lru_index_allocation_contract` |
| `test` | `c_preprocess_macro_decode_allocation_contract` | `vyre-libs/tests/c_preprocess_macro_decode_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_macro_decode_allocation_contract` |
...
| `test` | `c_preprocess_macro_rescan_performance_contract` | `vyre-libs/tests/c_preprocess_macro_rescan_performance_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_macro_rescan_performance_contract` |
| `test` | `c_preprocess_macro_staging_allocation_contract` | `vyre-libs/tests/c_preprocess_macro_staging_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_macro_staging_allocation_contract` |
...
| `test` | `c_preprocess_payload_memory_cache_contract` | `vyre-libs/tests/c_preprocess_payload_memory_cache_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_payload_memory_cache_contract` |
...
| `test` | `c_preprocess_token_provenance_allocation_contract` | `vyre-libs/tests/c_preprocess_token_provenance_allocation_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test c_preprocess_token_provenance_allocation_contract` |
...
| `test` | `decode_cpu_api_boundary` | `vyre-libs/tests/decode_cpu_api_boundary.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test decode_cpu_api_boundary` |
...
| `test` | `hash_single_source_contracts` | `vyre-libs/tests/hash_single_source_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test hash_single_source_contracts` |
...
| `test` | `matching_nfa_mega_scan_contracts` | `vyre-libs/tests/matching_nfa_mega_scan_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test matching_nfa_mega_scan_contracts` |
...
| `test` | `nfa_module_organization` | `vyre-libs/tests/nfa_module_organization.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test nfa_module_organization` |
...
| `test` | `rule_pipeline_wire_contracts` | `vyre-libs/tests/rule_pipeline_wire_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test rule_pipeline_wire_contracts` |
...
| `test` | `scan_parity_matrix` | `vyre-libs/tests/scan_parity_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test scan_parity_matrix` |
...
| `test` | `security_cpu_oracle_boundary` | `vyre-libs/tests/security_cpu_oracle_boundary.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-libs --test security_cpu_oracle_boundary` |
