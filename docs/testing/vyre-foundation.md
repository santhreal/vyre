...
| `test` | `atomic_minimize_operand_positions` | `vyre-foundation/tests/atomic_minimize_operand_positions.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test atomic_minimize_operand_positions` |
...
| `test` | `expr_type_single_owner` | `vyre-foundation/tests/expr_type_single_owner.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test expr_type_single_owner` |
...
| `test` | `ir_variant_shape_owner_closure` | `vyre-foundation/tests/ir_variant_shape_owner_closure.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test ir_variant_shape_owner_closure` |
...
| `test` | `memory_pass_alias_owner` | `vyre-foundation/tests/memory_pass_alias_owner.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test memory_pass_alias_owner` |
...
| `test` | `operation_tier_classification` | `vyre-foundation/tests/operation_tier_classification.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test operation_tier_classification` |
...
| `test` | `optimizer_pass_borrow_preservation` | `vyre-foundation/tests/optimizer_pass_borrow_preservation.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test optimizer_pass_borrow_preservation` |
...
| `test` | `parallelism_subgroup_operand_reads` | `vyre-foundation/tests/parallelism_subgroup_operand_reads.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test parallelism_subgroup_operand_reads` |
...
| `test` | `scalar_operator_agreement` | `vyre-foundation/tests/scalar_operator_agreement.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test scalar_operator_agreement` |
...
| `test` | `validator_limits_and_options` | `vyre-foundation/tests/validator_limits_and_options.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-foundation --test validator_limits_and_options` |
