...
| `test` | `c_ast_expression_statement_semantic_contracts` | `vyre-driver-wgpu/tests/c_ast_expression_statement_semantic_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test c_ast_expression_statement_semantic_contracts` |
| `test` | `c_ast_expression_support` | `vyre-driver-wgpu/tests/c_ast_expression_support.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test c_ast_expression_support` |
...
| `test` | `c_parser_hostile_malformed_stream_contracts` | `vyre-driver-wgpu/tests/c_parser_hostile_malformed_stream_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test c_parser_hostile_malformed_stream_contracts` |
...
| `test` | `c_preprocess_gpu_filter_source` | `vyre-driver-wgpu/tests/c_preprocess_gpu_filter_source.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test c_preprocess_gpu_filter_source` |
...
| `test` | `engine_cache_adversarial` | `vyre-driver-wgpu/tests/engine_cache_adversarial.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test engine_cache_adversarial` |
...
| `test` | `gpu_device_contract` | `vyre-driver-wgpu/tests/gpu_device_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test gpu_device_contract` |
...
| `test` | `literal_set_parity` | `vyre-driver-wgpu/tests/literal_set_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test literal_set_parity` |
...
| `test` | `organization_contracts` | `vyre-driver-wgpu/tests/organization_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test organization_contracts` |
...
| `test` | `pipeline_modularity_contract` | `vyre-driver-wgpu/tests/pipeline_modularity_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test pipeline_modularity_contract` |
...
| `test` | `resident_pipeline_cache_contract` | `vyre-driver-wgpu/tests/resident_pipeline_cache_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test resident_pipeline_cache_contract` |
| `test` | `resident_scan_parity` | `vyre-driver-wgpu/tests/resident_scan_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-wgpu --test resident_scan_parity` |
