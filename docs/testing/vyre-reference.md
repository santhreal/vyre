...
| `test` | `dual_scalar_evaluator_matrix` | `vyre-reference/tests/dual_scalar_evaluator_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-reference --test dual_scalar_evaluator_matrix` |
...
| `test` | `storage_graph_scalar_matrix` | `vyre-reference/tests/storage_graph_scalar_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-reference --test storage_graph_scalar_matrix` |
| `test` | `subgroup_collectives_are_lane_identified` | `vyre-reference/tests/subgroup_collectives_are_lane_identified.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-reference --test subgroup_collectives_are_lane_identified` |
...
| `test` | `typed_validation_source` | `vyre-reference/tests/typed_validation_source.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-reference --test typed_validation_source` |
