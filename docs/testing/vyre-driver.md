...
| `test` | `duplicate_op_id` | `vyre-driver/tests/duplicate_op_id.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver --test duplicate_op_id` |
...
| `test` | `organization_contracts` | `vyre-driver/tests/organization_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver --test organization_contracts` |
