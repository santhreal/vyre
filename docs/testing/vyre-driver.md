...
| `test` | `cache_invalidation_default` | `vyre-driver/tests/cache_invalidation_default.rs` | `self-substrate-adapters` | `./cargo_full test -p vyre-driver --test cache_invalidation_default` |
