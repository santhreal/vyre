...
| `test` | `adversarial_text_byte_histogram` | `vyre-primitives/tests/adversarial_text_byte_histogram.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test adversarial_text_byte_histogram` |
| `test` | `adversarial_text_byte_histogram` | `vyre-primitives/tests/adversarial_text_byte_histogram.rs` | `cpu-parity`, `text` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test adversarial_text_byte_histogram` |
...
| `test` | `adversarial_text_utf8_shape_counts` | `vyre-primitives/tests/adversarial_text_utf8_shape_counts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test adversarial_text_utf8_shape_counts` |
| `test` | `adversarial_text_utf8_shape_counts` | `vyre-primitives/tests/adversarial_text_utf8_shape_counts.rs` | `cpu-parity`, `text` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test adversarial_text_utf8_shape_counts` |
...
| `test` | `csr_closure_argument_bundle_gate` | `vyre-primitives/tests/csr_closure_argument_bundle_gate.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test csr_closure_argument_bundle_gate` |
...
| `test` | `csr_sweep_arm_coverage` | `vyre-primitives/tests/csr_sweep_arm_coverage.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test csr_sweep_arm_coverage` |
