...
| `test` | `adversarial_range` | `vyre-primitives/tests/adversarial_range.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test adversarial_range` |
...
| `test` | `cpu_oracle_boundary` | `vyre-primitives/tests/cpu_oracle_boundary.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test cpu_oracle_boundary` |
...
| `test` | `csr_edge_scan_one_place` | `vyre-primitives/tests/csr_edge_scan_one_place.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test csr_edge_scan_one_place` |
...
| `test` | `generated_graph_oracle_matrix` | `vyre-primitives/tests/generated_graph_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test generated_graph_oracle_matrix` |
| `test` | `generated_graph_oracle_matrix` | `vyre-primitives/tests/generated_graph_oracle_matrix.rs` | `cpu-parity`, `graph` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test generated_graph_oracle_matrix` |
...
| `test` | `hostbuf_reserve_one_place` | `vyre-primitives/tests/hostbuf_reserve_one_place.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test hostbuf_reserve_one_place` |
...
| `test` | `proptest_persistent_bfs_bitset_words` | `vyre-primitives/tests/proptest_persistent_bfs_bitset_words.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test proptest_persistent_bfs_bitset_words` |
...
| `test` | `quantized_module_organization` | `vyre-primitives/tests/quantized_module_organization.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test quantized_module_organization` |
...
| `test` | `sweep_bitset_and_not_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_and_not_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_and_not_volume_oracle_matrix` |
| `test` | `sweep_bitset_and_not_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_and_not_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_and_not_volume_oracle_matrix` |
| `test` | `sweep_bitset_any_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_any_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_any_volume_oracle_matrix` |
| `test` | `sweep_bitset_any_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_any_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_any_volume_oracle_matrix` |
| `test` | `sweep_bitset_binary_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_binary_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_binary_oracle_matrix` |
| `test` | `sweep_bitset_binary_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_binary_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_binary_oracle_matrix` |
| `test` | `sweep_bitset_contains_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_contains_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_contains_volume_oracle_matrix` |
| `test` | `sweep_bitset_contains_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_contains_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_contains_volume_oracle_matrix` |
| `test` | `sweep_bitset_copy_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_copy_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_copy_volume_oracle_matrix` |
| `test` | `sweep_bitset_copy_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_copy_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_copy_volume_oracle_matrix` |
| `test` | `sweep_bitset_equal_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_equal_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_equal_volume_oracle_matrix` |
| `test` | `sweep_bitset_equal_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_equal_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_equal_volume_oracle_matrix` |
| `test` | `sweep_bitset_not_unary_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_not_unary_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_not_unary_volume_oracle_matrix` |
| `test` | `sweep_bitset_not_unary_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_not_unary_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_not_unary_volume_oracle_matrix` |
| `test` | `sweep_bitset_popcount_unary_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_popcount_unary_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_popcount_unary_volume_oracle_matrix` |
| `test` | `sweep_bitset_popcount_unary_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_popcount_unary_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_popcount_unary_volume_oracle_matrix` |
| `test` | `sweep_bitset_stochastic_and_mul_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_stochastic_and_mul_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_stochastic_and_mul_volume_oracle_matrix` |
| `test` | `sweep_bitset_stochastic_and_mul_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_stochastic_and_mul_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_stochastic_and_mul_volume_oracle_matrix` |
| `test` | `sweep_bitset_subset_of_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_subset_of_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_subset_of_volume_oracle_matrix` |
| `test` | `sweep_bitset_subset_of_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_subset_of_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_subset_of_volume_oracle_matrix` |
| `test` | `sweep_bitset_test_bit_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_test_bit_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_test_bit_volume_oracle_matrix` |
| `test` | `sweep_bitset_test_bit_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_test_bit_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_test_bit_volume_oracle_matrix` |
| `test` | `sweep_bitset_zero_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_zero_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_zero_volume_oracle_matrix` |
| `test` | `sweep_bitset_zero_volume_oracle_matrix` | `vyre-primitives/tests/sweep_bitset_zero_volume_oracle_matrix.rs` | `bitset`, `cpu-parity` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_bitset_zero_volume_oracle_matrix` |
...
| `test` | `sweep_reduce_count_non_zero_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_count_non_zero_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_count_non_zero_volume_oracle_matrix` |
| `test` | `sweep_reduce_count_non_zero_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_count_non_zero_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_count_non_zero_volume_oracle_matrix` |
| `test` | `sweep_reduce_count_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_count_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_count_volume_oracle_matrix` |
| `test` | `sweep_reduce_count_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_count_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_count_volume_oracle_matrix` |
| `test` | `sweep_reduce_gather_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_gather_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_gather_volume_oracle_matrix` |
| `test` | `sweep_reduce_gather_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_gather_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_gather_volume_oracle_matrix` |
| `test` | `sweep_reduce_histogram_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_histogram_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_histogram_volume_oracle_matrix` |
| `test` | `sweep_reduce_histogram_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_histogram_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_histogram_volume_oracle_matrix` |
| `test` | `sweep_reduce_max_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_max_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_max_volume_oracle_matrix` |
| `test` | `sweep_reduce_max_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_max_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_max_volume_oracle_matrix` |
| `test` | `sweep_reduce_min_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_min_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_min_volume_oracle_matrix` |
| `test` | `sweep_reduce_min_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_min_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_min_volume_oracle_matrix` |
| `test` | `sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix` |
| `test` | `sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_multi_block_prefix_scan_volume_oracle_matrix` |
| `test` | `sweep_reduce_range_counts_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_range_counts_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_range_counts_volume_oracle_matrix` |
| `test` | `sweep_reduce_range_counts_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_range_counts_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_range_counts_volume_oracle_matrix` |
| `test` | `sweep_reduce_scalar_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scalar_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scalar_oracle_matrix` |
| `test` | `sweep_reduce_scalar_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scalar_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scalar_oracle_matrix` |
| `test` | `sweep_reduce_scalar_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scalar_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scalar_volume_oracle_matrix` |
| `test` | `sweep_reduce_scalar_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scalar_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scalar_volume_oracle_matrix` |
| `test` | `sweep_reduce_scatter_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scatter_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scatter_volume_oracle_matrix` |
| `test` | `sweep_reduce_scatter_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_scatter_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_scatter_volume_oracle_matrix` |
| `test` | `sweep_reduce_sum_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_sum_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_sum_volume_oracle_matrix` |
| `test` | `sweep_reduce_sum_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_sum_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_sum_volume_oracle_matrix` |
| `test` | `sweep_reduce_workgroup_any_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_workgroup_any_volume_oracle_matrix.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_workgroup_any_volume_oracle_matrix` |
| `test` | `sweep_reduce_workgroup_any_volume_oracle_matrix` | `vyre-primitives/tests/sweep_reduce_workgroup_any_volume_oracle_matrix.rs` | `cpu-parity`, `reduce` | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-primitives --test sweep_reduce_workgroup_any_volume_oracle_matrix` |
