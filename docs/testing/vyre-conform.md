...
| `test` | `cert_artifact` | `conform/vyre-conform/tests/cert_artifact.rs` | None | `./cargo_full test -p vyre-conform --test cert_artifact` |
| `test` | `cert_regression_pin` | `conform/vyre-conform/tests/cert_regression_pin.rs` | None | `./cargo_full test -p vyre-conform --test cert_regression_pin` |
...
| `test` | `countless_readwrite_output_parity` | `conform/vyre-conform/tests/countless_readwrite_output_parity.rs` | None | `./cargo_full test -p vyre-conform --test countless_readwrite_output_parity` |
| `test` | `countless_readwrite_output_parity` | `conform/vyre-conform/tests/countless_readwrite_output_parity.rs` | `gpu` | `./cargo_full test -p vyre-conform --test countless_readwrite_output_parity` |
