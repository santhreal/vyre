...
| `test` | `megakernel_barrier_elision_variant_closure` | `vyre-runtime/tests/megakernel_barrier_elision_variant_closure.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-runtime --test megakernel_barrier_elision_variant_closure` |
...
| `test` | `registry_closure` | `vyre-runtime/tests/registry_closure.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-runtime --test registry_closure` |
