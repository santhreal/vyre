...
| `test` | `compiled_grid_sync_pipeline_contracts` | `vyre-driver-cuda/tests/compiled_grid_sync_pipeline_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test compiled_grid_sync_pipeline_contracts` |
...
| `test` | `cuda_device_contract` | `vyre-driver-cuda/tests/cuda_device_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test cuda_device_contract` |
...
| `test` | `cuda_release_surface_contracts` | `vyre-driver-cuda/tests/cuda_release_surface_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test cuda_release_surface_contracts` |
...
| `test` | `i3_i4_integration` | `vyre-driver-cuda/tests/i3_i4_integration.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test i3_i4_integration` |
...
| `test` | `math_more_primitives_gpu_parity` | `vyre-driver-cuda/tests/math_more_primitives_gpu_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test math_more_primitives_gpu_parity` |
...
| `test` | `misc_primitives_batch_gpu_parity` | `vyre-driver-cuda/tests/misc_primitives_batch_gpu_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test misc_primitives_batch_gpu_parity` |
...
| `test` | `pipeline_modularity_contract` | `vyre-driver-cuda/tests/pipeline_modularity_contract.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test pipeline_modularity_contract` |
...
| `test` | `resident_io_fusion_contracts` | `vyre-driver-cuda/tests/resident_io_fusion_contracts.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test resident_io_fusion_contracts` |
| `test` | `resident_presence_8mib_dispatch_attribution` | `vyre-driver-cuda/tests/resident_presence_8mib_dispatch_attribution.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test resident_presence_8mib_dispatch_attribution` |
| `test` | `resident_presence_cuda_parity` | `vyre-driver-cuda/tests/resident_presence_cuda_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test resident_presence_cuda_parity` |
| `test` | `resident_scan_cuda_parity` | `vyre-driver-cuda/tests/resident_scan_cuda_parity.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-driver-cuda --test resident_scan_cuda_parity` |
