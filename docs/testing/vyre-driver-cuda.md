...
| `test` | `borrowck_reachability_cuda` | `vyre-driver-cuda/tests/borrowck_reachability_cuda.rs` | None | `./cargo_full test -p vyre-driver-cuda --test borrowck_reachability_cuda` |
