...
| `test` | `adaptive_four_russians_resident_source_guard` | `vyre-self-substrate/tests/adaptive_four_russians_resident_source_guard.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-self-substrate --test adaptive_four_russians_resident_source_guard` |
...
| `test` | `graph_frontier_single_source` | `vyre-self-substrate/tests/graph_frontier_single_source.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-self-substrate --test graph_frontier_single_source` |
...
| `test` | `graph_wrapper_boundaries` | `vyre-self-substrate/tests/graph_wrapper_boundaries.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-self-substrate --test graph_wrapper_boundaries` |
...
| `test` | `via_gpu_boundary` | `vyre-self-substrate/tests/via_gpu_boundary.rs` | None | `CARGO_BUILD_JOBS=1 ./cargo_full test -p vyre-self-substrate --test via_gpu_boundary` |
