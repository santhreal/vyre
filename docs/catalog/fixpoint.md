...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `vyre-primitives::fixpoint::bitset_fixpoint` | `intrinsic` | `fixpoint` | 0:current:ReadOnly:U32<br>1:next:ReadOnly:U32<br>2:fp_changed:ReadWrite:U32 | `fixpoint`<br>`inventory-registry` | reference=true inputs=true expected=true tolerance=0 ULP | cuda:supported<br>reference:supported<br>wgpu:supported | none declared | vyre-primitives::fixpoint::bitset_fixpoint |
| `vyre-primitives::fixpoint::persistent_fixpoint` | `intrinsic` | `fixpoint` | 0:current:ReadWrite:U32<br>1:next:ReadWrite:U32<br>2:changed:ReadWrite:U32 | `fixpoint`<br>`inventory-registry` | reference=true inputs=true expected=true tolerance=0 ULP | cuda:supported<br>reference:supported<br>wgpu:supported | none declared | vyre-primitives::fixpoint::persistent_fixpoint |
