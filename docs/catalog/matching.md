...
| `vyre-primitives::matching::bracket_match` | `primitive` | `matching` | 0:kinds:ReadOnly:U32<br>1:stack:ReadWrite:U32<br>2:match_pairs:ReadWrite:U32 | `matching`<br>`inventory-registry` | reference=true inputs=true expected=true tolerance=0 ULP | cuda:supported<br>reference:supported<br>wgpu:supported | none declared | vyre-primitives::matching::bracket_match |
