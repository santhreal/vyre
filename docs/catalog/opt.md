...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `vyre-primitives::opt::homotopy_euler_predictor` | `primitive` | `opt` | 0:x_curr:ReadOnly:U32<br>1:v:ReadOnly:U32<br>2:dt_scaled:ReadOnly:U32<br>3:x_pred:ReadWrite:U32 | `opt`<br>`inventory-registry` | reference=true inputs=true expected=true tolerance=0 ULP | cuda:supported<br>reference:supported<br>wgpu:supported | none declared | vyre-primitives::opt::homotopy_euler_predictor |
