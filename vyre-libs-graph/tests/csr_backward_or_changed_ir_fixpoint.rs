...
use vyre_libs_graph::graph::csr_backward_or_changed::csr_backward_or_changed_parallel;
use vyre_libs_graph::graph::program_graph::ProgramGraphShape;
use vyre_primitives::wire::{decode_u32_le_bytes_all as unpack, pack_u32_slice as pack};
use vyre_reference::composition_witness::csr_backward_closure_witness as cpu_ref_closure;
...
fn ir_program_fixpoint_matches_cpu_ref_closure_across_generated_shapes() {
    for seed in 1..3072u32 {
        ...
        let oracle = cpu_ref_closure(node_count, &offsets, &targets, &masks, &frontier, allow);
