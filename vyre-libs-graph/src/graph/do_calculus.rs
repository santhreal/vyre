...
pub const IMPACT_MASK_OP_ID: &str = "vyre-libs::graph::do_impact_mask_from_closure";
...
pub fn try_intervention_delete_incoming(
    ...
    let cells = vyre_libs_builder::plumbing::operand::shape::square_matrix_cells(OP_ID, n)?;
...
pub fn try_impact_mask_from_closure(
    intervention_mask: &str,
    closure: &str,
    impact_mask: &str,
    n: u32,
