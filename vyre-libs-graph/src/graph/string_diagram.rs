...
use vyre_libs_math::math::fixed_u32_matmul::{try_fixed_u32_matmul, FixedMatmulContext};
...
/// `vyre_libs_math::math::tensor_network::tn_pair_contract`; ships under graph because
