...
pub fn try_sheaf_diffusion_step(
    ...
    let cells = vyre_libs_builder::plumbing::operand::shape::matrix_cells(OP_ID, n_nodes, d)?;
    ...
    let damped_r = vyre_libs_math::math::fixed::fixed_mul_16_16_expr(d_v, r);
    let delta = vyre_libs_math::math::fixed::fixed_mul_16_16_expr(damped_r, s.clone());
