...
pub fn try_rule2_reverse_incoming(
    ...
    let cells = vyre_libs_builder::plumbing::operand::shape::square_matrix_cells(RULE2_OP_ID, n)?;
...
pub fn try_rule3_subgraph(
    ...
    let cells = vyre_libs_builder::plumbing::operand::shape::square_matrix_cells(RULE3_OP_ID, n)?;
