...
This crate is the `libraries` layer's `libs-reduce` seam, at `vyre-libs-reduce`.
Every production dependency on it crosses Workgroup reduction tree, atomic scalar reduction and prefix scan compositions.
