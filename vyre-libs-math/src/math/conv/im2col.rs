...
pub(super) use vyre_libs_builder::builder::stencil::sample_stencil_3x3_or_zero as patch_cell;
pub(super) use vyre_libs_builder::builder::stencil::stencil_3x3_taps as patch_taps;
...
mod tests {
    ...
    fn columns(input: &[f32], h: u32, w: u32) -> Vec<f32> {
        ...
        decode(&vyre_libs_builder::fixture_bytes::eval_bytes("im2col_3x3", &program, vec![f32_bytes(input)])[0])
    }
