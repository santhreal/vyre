...
use vyre_libs_math::math::padic::hensel_lift_step;
...
fn hensel_lift_signed_matches_exact_fixed_point_step() {
    ...
    for case in 0..400u32 {
        ...
        coverage.operands(x.iter().chain(&f_x).chain(&inv_f_prime));
    ...
    coverage.assert_floors("padic_hensel::hensel_lift_step", 800, 100, 380);
}
