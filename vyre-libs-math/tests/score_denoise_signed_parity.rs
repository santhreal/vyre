...
use vyre_libs_math::math::score_denoise::score_denoise_step;
...
fn score_denoise_signed_matches_exact_fixed_point_blend() {
    ...
    for case in 0..400u32 {
        ...
        coverage.operands(x.iter().chain(&score).chain(&noise));
    ...
    coverage.assert_floors("score_denoise::score_denoise_step", 800, 100, 380);
}
