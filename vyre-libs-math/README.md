...
The `product-libraries` owner maintains this `libraries` crate at `vyre-libs-math`.
Its allowed internal production dependencies are: `vyre-foundation`, `vyre-libs-builder`, `vyre-libs-fixpoint`, `vyre-libs-reduce`, `vyre-megakernel`, `vyre-primitives`, `vyre-spec`.
