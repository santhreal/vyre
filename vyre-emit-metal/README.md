...
```console
CARGO_BUILD_JOBS=1 ./cargo_full run -p vyre-emit-metal --example vyre_emit_metal_release_surface
```
...
Use [`docs/testing/vyre-emit-metal.md`](../docs/testing/vyre-emit-metal.md) for exact commands, Cargo targets, hardware
