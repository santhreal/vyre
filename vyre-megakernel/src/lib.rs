...
pub use schema::{
    ...
    EntryPersistence, EntryResourceBinding, ExecutionMode,
    FrontierTopology as SchemaFrontierTopology, FusionRecord, FusionRejection, GeometryRecord,
    LaunchResourceIntent, MaterializationReason, MaterializationRecord, NodeRecord, NumericRecord,
