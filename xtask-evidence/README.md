...
Commands: `backend-matrix`, `bench-crossback`, `bench-release`, `release-benchmarks`, `release-certificate`, `release-evidence`, `release-workload-matrix`, `vyre-release-gate`, `whole-app-evidence`.
...
```console
./cargo_full run -p xtask-evidence -- --help
```
...
See [`docs/testing/xtask-evidence.md`](../docs/testing/xtask-evidence.md) for the crate's test command,
