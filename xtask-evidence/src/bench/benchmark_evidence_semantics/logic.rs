//! How benchmark release evidence is judged.
//!
//! Every check reads the tables in `data` and turns a report into the
//! findings that module names. Nothing here decides what release evidence
//! must contain; it decides whether a given artifact says it.
