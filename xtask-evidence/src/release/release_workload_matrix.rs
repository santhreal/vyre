...
pub struct ReleaseWorkloadMatrixGate;

impl Gate for ReleaseWorkloadMatrixGate {
    fn name(&self) -> &'static str {
        "release-workload-matrix"
    }

    fn help(&self) -> &'static str {
        "Rebuild release/evidence/benchmarks/release-workload-matrix.json from the benchmark case \
