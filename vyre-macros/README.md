...
```console
CARGO_BUILD_JOBS=1 ./cargo_full run -p vyre-macros --example vyre_macros_release_surface
```
...
Use [`docs/testing/vyre-macros.md`](../docs/testing/vyre-macros.md) for exact commands, Cargo targets, hardware
