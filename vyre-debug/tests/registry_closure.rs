...
//! checks, and a diagnostic rendered from a drifted fixture proves nothing. It
//! still compiles, still appears in the catalog documents that are generated
...
///
/// This crate publishes one fixture builder. Any floor below the measured count
/// would be a floor of zero here, and zero builders are what a broken scan
/// reports, so the floor is the measured count. Adding a fixture never fails
/// this; removing the last one is a decision that has to be recorded on this
/// line.
