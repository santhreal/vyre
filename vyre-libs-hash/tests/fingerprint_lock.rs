...
#[test]
fn fp_dot() {
    use vyre_libs_math::math::linalg::dot;
...
fn fp_scan_prefix_sum() {
    use vyre_libs_math::math::scan::scan_prefix_sum;
...
#[test]
fn fp_broadcast() {
    use vyre_libs_math::math::broadcast::broadcast;
...
#[test]
fn fp_relu() {
    use vyre_libs_nn::nn::activation::relu;
    let p = relu("in", "out", 4);
...
#[test]
fn fp_linear() {
    use vyre_libs_nn::nn::linear::linear;
...
#[test]
fn fp_softmax() {
    use vyre_libs_nn::nn::attention::softmax;
...
#[test]
fn fp_attention() {
    use vyre_libs_nn::nn::attention::attention;
...
fn fp_blake3_compress() {
    use vyre_libs_hash::hash::blake3_compress;
