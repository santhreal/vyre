...
//! dispatch shape nobody runs. It still compiles, still appears in the catalog
//! documents that are generated from source, and still diverges from its
//! reference arm with nothing red. The enumerator that closes this gap lives in
//! `vyre-test-support`; this file is the caller for this crate.
//!
...
/// that folding two of them together does not need this line edited, and high
/// enough that a parser regression which drops most of the tree fails instead
/// of reporting a clean sweep of a nearly empty set.
const BUILDER_FLOOR: usize = 10;
