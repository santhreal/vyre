...
This crate is the `libraries` layer's `libs-analysis` seam, at `vyre-libs-analysis`.
Every production dependency on it crosses Static analysis, cost model, dataflow fixpoint and diagnostic compositions.
