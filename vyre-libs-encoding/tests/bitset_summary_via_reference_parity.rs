...
use vyre_libs_encoding::encoding::bitset_summary::{per_word_popcount_via, total_set_bits_via};
...
fn popcount_via_matches_inline_count_ones_oracle() {
    ...
    for case in 0..400u32 {
        ...
        let got = per_word_popcount_via(&dispatcher, &semantic_requests::wrapper_policy(), &input)
        ...
        assert_eq!(
            total_set_bits_via(&dispatcher, &semantic_requests::wrapper_policy(), &input).unwrap(),
            want_total,
