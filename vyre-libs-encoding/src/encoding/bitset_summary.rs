...
//!
//! Wires `vyre_libs_bitset::bitset::popcount` and several companion bitset
...
fn bitset_saturation_ratio(input: &str, output: &str, words: u32) -> Program {
    ...
    let phase = vyre_libs_builder::builder::reduction::ReductionPhase {
        ...
        reductions: vec![vyre_libs_reduce::reduce::workgroup_tree::sum_f32_child(
            SATURATION_RATIO_OP_ID,
            tile,
            "sat_scratch",
            vyre_libs_reduce::reduce::workgroup_tree::WorkgroupReductionScope::FirstWorkgroup,
        )],
    ...
    vyre_libs_builder::builder::reduction::ReductionComposer::new(
        SATURATION_RATIO_OP_ID,
        vec![
...
pub fn total_set_bits_via_with_scratch_into(
    ...
    let program = vyre_libs_reduce::reduce::count::reduce_count("input", "out", word_count);
