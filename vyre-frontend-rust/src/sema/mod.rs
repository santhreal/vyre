//! Semantic analysis for the supported Rust source subset.
//!
//! Analyses are frontend-owned side tables over a borrowed AST. They have no
//! dependency on facade, runtime, product-library, or execution crates.
//!
