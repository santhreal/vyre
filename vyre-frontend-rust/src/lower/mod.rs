//! Rust AST to backend-neutral Vyre IR lowering.
//!
//! Lowering borrows the frontend-owned AST and semantic resolution, producing a
//! [`vyre_foundation::ir::Program`] without selecting an execution backend.
//!
//! ## Model (nano-subset)
//!
...
//! [`RustLowerError::Unsupported`](crate::lower::RustLowerError::Unsupported) rather than miscompiling.

use std::collections::HashMap;

use thiserror::Error;
use vyre_foundation::ir::{BufferDecl, DataType, Expr as IrExpr, Node, Program};
